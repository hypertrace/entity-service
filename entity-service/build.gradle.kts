...
dependencies {
  ...
  implementation("org.hypertrace.core.documentstore:document-store:0.7.60")
  ...
  integrationTestImplementation("org.hypertrace.core.grpcutils:grpc-context-utils:0.13.1")
