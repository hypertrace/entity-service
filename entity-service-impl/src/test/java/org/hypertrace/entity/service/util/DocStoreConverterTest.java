...
public class DocStoreConverterTest {
  ...
  private static final List<String> MULTI_VALUE_ATTRIBUTES =
      Collections.singletonList("attributes.labels");
  ...
  public void testEntityQueryLimitOffsetConversion() {
    ...
    org.hypertrace.core.documentstore.Query transformedQuery =
        DocStoreConverter.transform(
            TENANT_ID, query, Collections.emptyList(), MULTI_VALUE_ATTRIBUTES);
  ...
  public void testEntityFieldsQueryConversion() {
    ...
    Assertions.assertEquals(
        EntityServiceConstants.ENTITY_ID, transformedFilter.getChildFilters()[1].getFieldName());
    Assertions.assertEquals(
        Collections.singletonList("some id"), transformedFilter.getChildFilters()[1].getValue());
    ...
    Assertions.assertEquals(Filter.Op.IN, transformedFilter.getChildFilters()[1].getOp());
    Assertions.assertEquals(
        EntityServiceConstants.ENTITY_NAME, transformedFilter.getChildFilters()[2].getFieldName());
  ...
  public void testAttributeValueConversion() {
    ...
    Assertions.assertEquals(
        "attributes.value.string", transformedFilter.getChildFilters()[1].getFieldName());
  ...
  public void testEntityFieldAndAttributeValueConversion() {
    ...
    Assertions.assertEquals(
        Collections.singletonList("some id"), transformedFilter.getChildFilters()[1].getValue());
    Assertions.assertEquals(
        "attributes.value.string", transformedFilter.getChildFilters()[2].getFieldName());
  ...
  public void testFilterNonAttributesFieldNames() {
    ...
    Assertions.assertEquals(
        Collections.singletonList("some id"), transformedFilter.getChildFilters()[1].getValue());
    Assertions.assertEquals(
        "API.createdTime", transformedFilter.getChildFilters()[2].getFieldName());
  ...
  public void testOrderByConversion() {
    Query query =
        Query.newBuilder()
            .addEntityId("some id")
            .addOrderBy(
                OrderByExpression.newBuilder().setName("col1").setOrder(SortOrder.DESC).build())
            .addOrderBy(OrderByExpression.newBuilder().setName("col2").build())
            .build();
    org.hypertrace.core.documentstore.Query transformedQuery =
        DocStoreConverter.transform(
            TENANT_ID, query, Collections.emptyList(), MULTI_VALUE_ATTRIBUTES);
  ...
  public void testSelectionsWithOrderBy() {
    ...
    org.hypertrace.core.documentstore.Query transformedQuery =
        DocStoreConverter.transform(
            TENANT_ID, query, List.of("selection1", "selection2"), MULTI_VALUE_ATTRIBUTES);
  ...
  public void testInFilterConversion() {
    ...
    Assertions.assertEquals(Filter.Op.IN, transformedFilter.getChildFilters()[1].getOp());
    Assertions.assertEquals(
        List.of("attr-v1", "attr-v2", "attr-v3"),
    ...
    org.hypertrace.core.documentstore.Query transformedQuery2 =
        DocStoreConverter.transform(
            TENANT_ID, query2, Collections.emptyList(), MULTI_VALUE_ATTRIBUTES);
    ...
    Assertions.assertEquals(
        "attributes.value.string", transformedFilter2.getChildFilters()[1].getFieldName());
                        ...
                        AttributeValue.newBuilder()
                            .setValueList(
                                AttributeValueList.newBuilder()
                                    .addValues(
                                        AttributeValue.newBuilder()
                                            .setValue(Value.newBuilder().setLong(21L)))
                                    .addValues(
                                        AttributeValue.newBuilder()
                                            .setValue(Value.newBuilder().setLong(22L))))
                            .build())
                    .build())
            .build();
    org.hypertrace.core.documentstore.Query transformedQuery3 =
        DocStoreConverter.transform(
            TENANT_ID, query3, Collections.emptyList(), MULTI_VALUE_ATTRIBUTES);
    ...
    Assertions.assertEquals(
        "attributes.value.long", transformedFilter3.getChildFilters()[1].getFieldName());
    ...
    org.hypertrace.core.documentstore.Query transformedQuery4 =
        DocStoreConverter.transform(
            TENANT_ID, query4, Collections.emptyList(), MULTI_VALUE_ATTRIBUTES);
  ...
  public void testEqFilterConversionForValueList() throws IOException {
                            ...
                            .setValueList(
                                AttributeValueList.newBuilder()
                                    .addValues(
                                        AttributeValue.newBuilder()
                                            .setValue(
                                                Value.newBuilder().setString("{\"a1\":\"v1\"}")))
                                    .addValues(
                                        AttributeValue.newBuilder()
                                            .setValue(
                                                Value.newBuilder().setString("{\"a2\":\"v2\"}")))
                                    .addValues(
                                        AttributeValue.newBuilder()
                                            .setValue(
                                                Value.newBuilder().setString("{\"a3\":\"v3\"}"))))
                            .build())
                    .build())
            .build();
    org.hypertrace.core.documentstore.Query transformedQuery =
    ...
    Assertions.assertEquals(2, transformedFilter.getChildFilters().length);
    Assertions.assertEquals(
        "attributes.valueList.values", transformedFilter.getChildFilters()[1].getFieldName());
  ...
  public void testStringArrayValueTypeColumnEqAndChain() throws JsonProcessingException {
    ...
    Assertions.assertEquals(
        Op.EQ, transformedFilter.getChildFilters()[2].getChildFilters()[0].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l1\"}}"), Map.class),
    ...
    Assertions.assertEquals(
        Op.EQ, transformedFilter.getChildFilters()[2].getChildFilters()[1].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l2\"}}"), Map.class),
  ...
  public void testStringArrayValueTypeColumnNeqAndChain() throws JsonProcessingException {
    ...
    Assertions.assertEquals(
        ...
        transformedFilter.getChildFilters()[2].getChildFilters()[0].getFieldName());
    Assertions.assertEquals(
        Op.NEQ, transformedFilter.getChildFilters()[2].getChildFilters()[0].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l1\"}}"), Map.class),
        transformedFilter.getChildFilters()[2].getChildFilters()[0].getValue());
    ...
    Assertions.assertEquals(
        ...
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getFieldName());
    Assertions.assertEquals(
        Op.NEQ, transformedFilter.getChildFilters()[2].getChildFilters()[1].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l2\"}}"), Map.class),
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getValue());
  ...
  public void testStringArrayValueTypeColumnOrChain() throws JsonProcessingException {
    ...
    Assertions.assertEquals(
        "attributes.some_col.value.string",
        transformedFilter.getChildFilters()[2].getChildFilters()[0].getFieldName());
    Assertions.assertEquals(
        Op.EQ, transformedFilter.getChildFilters()[2].getChildFilters()[0].getOp());
    Assertions.assertEquals(
        "some_val", transformedFilter.getChildFilters()[2].getChildFilters()[0].getValue());

    Assertions.assertEquals(
        Op.OR, transformedFilter.getChildFilters()[2].getChildFilters()[1].getOp());

    Assertions.assertEquals(
        ATTRIBUTES_LABELS_FIELD_NAME + ".valueList.values",
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[0]
            .getFieldName());
    Assertions.assertEquals(
        Op.EQ,
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[0].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l1\"}}"), Map.class),
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[0]
    ...
    Assertions.assertEquals(
        ATTRIBUTES_LABELS_FIELD_NAME + ".valueList.values",
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[1]
            .getFieldName());
    Assertions.assertEquals(
        Op.EQ,
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[1].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l2\"}}"), Map.class),
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[1]
    ...
    Assertions.assertEquals(
        ATTRIBUTES_LABELS_FIELD_NAME + ".valueList.values",
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[2]
            .getFieldName());
    Assertions.assertEquals(
        Op.EQ,
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[2].getOp());
    Assertions.assertEquals(
        OBJECT_MAPPER.convertValue(
            OBJECT_MAPPER.readTree("{\"value\": {\"string\":\"l3\"}}"), Map.class),
        transformedFilter.getChildFilters()[2].getChildFilters()[1].getChildFilters()[2]
            .getValue());
  }
  ...
  public void testStringArrayValueTypeColumnAndChain() throws JsonProcessingException {
    ...
    Assertions.assertEquals(
        Op.AND, transformedFilter.getChildFilters()[2].getChildFilters()[1].getOp());
  ...
  private void testFilterOpConversionForEntityServiceOp(
      Operator operator, Filter.Op expectedFilterOp) {
