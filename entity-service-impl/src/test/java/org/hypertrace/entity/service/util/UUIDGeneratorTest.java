        ...
        AttributeValue.newBuilder()
            .setValueList(
                AttributeValueList.newBuilder()
                    .addValues(
                        AttributeValue.newBuilder()
                            .setValue(Value.newBuilder().setString("abc").build())
                            .build())
                    .addValues(
                        AttributeValue.newBuilder()
                            .setValue(Value.newBuilder().setString("xyz").build())
                            .build())
                    .build())
            .build());
    String uuid1 = UUIDGenerator.generateUUID(map1);
            ...
            .setValueMap(
                AttributeValueMap.newBuilder()
                    .putValues(
                        "nestedkey1",
                        AttributeValue.newBuilder()
                            .setValue(Value.newBuilder().setString("nestedValue1").build())
                            .build())
                    .putValues(
                        "nestedkey2",
                        AttributeValue.newBuilder()
                            .setValue(Value.newBuilder().setString("nestedValue2").build())
                            .build())
                    .putValues(
                        "nestedListvalue",
                        AttributeValue.newBuilder()
                            ...
                            .setValueMap(
                                AttributeValueMap.newBuilder()
                                    .putValues(
                                        "key1",
                                        AttributeValue.newBuilder()
                                            .setValue(Value.newBuilder().setString("val1").build())
                                            .build())
                                    .build())
                            .build())
                    .build())
