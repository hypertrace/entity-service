...
public class EdsTypeAndIdAttributesCacheKeyTest {
  ...
  public void testEqualsHashcode() {
    ...
    ByTypeAndIdentifyingAttributes attributes1 =
    ...
    EdsTypeAndIdAttributesCacheKey cacheKey1 =
        new EdsTypeAndIdAttributesCacheKey("tenant1", attributes1);
    EdsTypeAndIdAttributesCacheKey cacheKey2 =
        new EdsTypeAndIdAttributesCacheKey("tenant1", attributes1);
    ...
    EdsTypeAndIdAttributesCacheKey cacheKey3 =
        new EdsTypeAndIdAttributesCacheKey("tenant2", attributes1);
    Assertions.assertNotEquals(cacheKey1, cacheKey3);

    // only entity_type change, and same attributes
    ByTypeAndIdentifyingAttributes attributes2 =
        ByTypeAndIdentifyingAttributes.newBuilder()
            .setEntityType("SERVICE")
            .putAllIdentifyingAttributes(identifyingAttributesMap1)
            .build();
    EdsTypeAndIdAttributesCacheKey cacheKey4 =
        new EdsTypeAndIdAttributesCacheKey("tenant1", attributes2);
    ...
    identifyingAttributesMap1.put(
        "entity_name",
        AttributeValue.newBuilder()
            .setValue(Value.newBuilder().setString("GET /books").build())
            .build());
    identifyingAttributesMap1.put(
        "is_active",
        AttributeValue.newBuilder().setValue(Value.newBuilder().setBoolean(false).build()).build());

    ByTypeAndIdentifyingAttributes attributes3 =
        ByTypeAndIdentifyingAttributes.newBuilder()
            .setEntityType("API")
            .putAllIdentifyingAttributes(identifyingAttributesMap2)
            .build();
    EdsTypeAndIdAttributesCacheKey cacheKey5 =
        new EdsTypeAndIdAttributesCacheKey("tenant1", attributes3);
